...
### 💻 Projects
| 서비스명 | 개발 기간 | 상태                 | 설명                           | 비고 | 역할                                    |
|----------|------------|--------------------|------------------------------|------------------------------------------|---------------------------------------|
| [termterm:텀텀](https://github.com/MZ-OFFISSU) | 2022.12 ~ 2024.06 | Completed (서비스 종료) | IT 용어 학습 서비스                 | 숭실대학교 창업지원단 선정 Pre-스타트업팀 | 백엔드 서버 개발, 인프라 구축                     |
| [ITerview](https://github.com/BLACKPINK-SLJY) | 2023.04 ~ 2023.08 | Completed          | IT 직종 취준생을 위한 모의면접 서비스       | 2023 숭실대학교 컴퓨터학부 소프트웨어 공모전 은상 | 백엔드 서버 개발, 인프라 구축                     |
| [놀이터맵](https://gj.noritermap.com) | 2024.06 ~ | In Progress        | 광주광역시 놀이시설 위치 및 상세 정보 제공 서비스 | | 프론트엔드 개발, 백엔드 개발, 인프라 구축, 데이터 수집 및 정제 |

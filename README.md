...
| [ITerview](https://github.com/BLACKPINK-SLJY)                                      | 2023.04 ~ 2023.08 | Completed          | IT 직종 취준생을 위한 모의면접 서비스          | 2023 숭실대학교 소프트웨어공모전 은상                                  | 백엔드 서버 개발 (`Spring Boot`), 인프라 구축 (`AWS`)                                                                    |
...
| [macro-detector](https://github.com/thisIsJooS/macro-detector)                     | 2024.03 ~ 2024.06 | Deployed           | 매크로 프로그램을 이용한 부정 예약 자동 탐지 라이브러리 | npm 배포 완료 - [링크](https://www.npmjs.com/package/macro-detector), 2024 숭실대학교 소프트웨어공모전 학장상 | 설계, 개발 (`Javascript`),<br/> `npm`                                                                                 |
